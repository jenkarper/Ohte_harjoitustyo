...
Yllä esiteltyjen luokkien lisäksi käyttöliittymässä on kokoava luokka [YahtzeeGUI](https://github.com/jenkarper/YahtzeeDesktop/blob/master/Yahtzee/src/main/java/yahtzee/ui/YahtzeeGUI.java), pelkästään tietoa välittävien Alert-olioiden määrittelystä vastaava luokka [GameAlert](https://github.com/jenkarper/YahtzeeDesktop/blob/master/Yahtzee/src/main/java/yahtzee/ui/GameAlert.java) ja kirjautuneen pelaajan tiedot näyttävän näkymän luova [PPlayerStatsViewsView](https://github.com/jenkarper/YahtzeeDesktop/blob/master/Yahtzee/src/main/java/yahtzee/ui/PlayerStatsView.java). Niinikään _yahtzee.ui_-pakkauksessa sijaitsevan pääohjelmaluokan [Main](https://github.com/jenkarper/YahtzeeDesktop/blob/master/Yahtzee/src/main/java/yahtzee/ui/Main.java) tarkoituksena on välttää JavaFX:n käyttöön liittyvä ongelma jar-tiedoston generoinnissa: _Main_-luokan ainoa tehtävä on kutsua _YahtzeeGUI_-luokan main-metodia omassa main-metodissaan.
...
Pelin kuluessa _Game_-olion metodit huolehtivat heitoista ja pisteytyksestä. Tärkeimmät toiminnallisuutta toteuttavat metodit ovat
